 ...
 <head>
     ...
     <!-- CSS Files -->
     <link href="{{asset('backend')}}/css/material-dashboard.min.css?v=2.1.2" rel="stylesheet" />
 ...
 <body class="off-canvas-sidebar">
     ...
     <div class="wrapper wrapper-full-page">
         <div class="page-header login-page header-filter" filter-color="black"
             style="background-image: url('{{asset('backend')}}/img/login.jpg'); background-size: cover; background-position: top center;">
